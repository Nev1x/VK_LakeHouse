...
## stage-4
- **Learnings:** адверсарный regex-фаззинг обязателен, когда конфиг несёт regex — уязвимость
  на КОРОТКОМ входе не ловится тестом «длинный вход»; проход 1 FAIL по ReDoS-времени.
- **Deviations:** проход 1 FAIL → возврат в S3 (retry 1/2), evidence незатронутых осей
  переиспользован.
